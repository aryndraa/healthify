...
export const DiseaseCard = ({name, gejala, deskripsi}) => {
  ...
  return (
    <Link to={`/disease/${name}`} className="p-4 lg:p-6 2xl:p-8 bg-white min-w-full h-full rounded-xl lg:rounded-xxl hover:text-white hover:bg-secondary transition ease-in-out">
