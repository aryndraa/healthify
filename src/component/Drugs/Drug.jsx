...
export function DrugCard({ pricing, title, standFor, illustration, drugLevel, id }) {
	...
	return (
		<div className="items">
			<div
				onClick={handleClick}
				className="justify-between flex flex-col rounded-[40px] py-4 px-2 shadow-lg md:w-[408px] h-[400px] md:h-[500px] hover:cursor-pointer  bg-center bg-no-repeat 2xl:bg-cover"
				style={{
