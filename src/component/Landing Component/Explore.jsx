            ...
            <div className="grid grid-cols-1 min-[800px]:grid-cols-2 xl:grid-cols-4  gap-4 ">
                <div className="items">
                    ...
                    >
                        ...
                        <div className="absolute p-4 group-hover:mt-[-40px] transition-all duration-300">
                            <p className=" text-start font-semibold text--2xl text-black transition duration-300 group-hover:text-white">Find Nearest Index</p>
                ...
                <div className="items">
                    ...
                    >
                        ...
                        <div className="absolute p-5 group-hover:mt-[-40px] transition-all duration-300">
                            <p className=" text-start font-semibold text--2xl text-black transition duration-300 group-hover:text-white">Find Nearest Clinic</p>
                            <p className="text-start  text-white opacity-0 transition duration-300 group-hover:opacity-100">Know more about disease, so you can self diagnose or just learning!</p>
                        </div>
                    </div>
                </div>
                <div className="items">
                    ...
                    >
                        ...
                        <div className="absolute p-5 group-hover:mt-[-40px] transition-all duration-300">
                            <p className=" text-start font-semibold text--2xl text-black transition duration-300 group-hover:text-white">Browse Drugs</p>
                            <p className="text-start  text-white opacity-0 transition duration-300 group-hover:opacity-100">Know more about disease, so you can self diagnose or just learning!</p>
                        </div>
                    </div>
                </div>
                <div className="items">
                    ...
                    >
                        ...
                        <div className="absolute p-5 group-hover:mt-[-40px] transition-all duration-300">
                            <p className=" text-start font-semibold text--2xl text-black transition duration-300 group-hover:text-white">Disease Information</p>
                            <p className="text-start  text-white opacity-0 transition duration-300 group-hover:opacity-100">Know more about disease, so you can self diagnose or just learning!</p>
                        </div>
                    </div>
                </div>
