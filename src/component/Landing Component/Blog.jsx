		...
		>
			<div className="items">
				<div
					...
					className=" flex justify-between max-w-[549px] min-[1441px]:max-w-[1920px] w-screen py-[32px] px-[48px] bg-white rounded-[40px] items-center gap-2 group hover:cursor-pointer"
				>
