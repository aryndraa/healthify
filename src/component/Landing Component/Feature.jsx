...
export const Feature = () => {
    ...
    return (
        <motion.div
            ...
            className="grid grid-cols-1 min-[800px]:grid-cols-2 xl:grid-cols-4 gap-4 "
        >
            <div className="items group hover" onClick={() => navigate('/clinic')}>
                <div className="BOX hover:bg-[#213170] w-screen hover:text-white  transition-all duration-300">
                    <div className="flex justify-between  mb-[71px]   ">
                        <p className="text--4xl font-semibold w-1/2  ">Clinics Listed</p>
                        <svg
            ...
            <div className="items group" onClick={() => navigate('/pharmacy')}>
                <div className="BOX hover:bg-[#213170] w-screen hover:text-white  transition-all duration-300">
                    <div className="flex justify-between  mb-[71px]">
                        <p className="text--4xl font-semibold w-1/2  ">Supported Pharmacy</p>
                        <svg
                            className="rounded-full p-[10px] w-[50px] h-[50px] md:w-[72px] md:h-[72px] md:p-[20px]  transition-transform duration-300 bg-[#C5E5FF]  group-hover:border-solid group-hover:border-[#C5E5FF]  group-hover:border-[3px] group-hover:rotate-45  group-hover:bg-white "
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
            ...
            <div className="items ">
                <div className="BOX w-screen">
                    <div className="flex justify-between  mb-[71px]">
                        <p className="text--4xl font-semibold w-1/2  ">Our Patient</p>
                    </div>
            ...
            <div className="items   group" onClick={() => navigate('/disease')}>
                <div className="BOX hover:bg-[#213170] hover:text-white w-screen transition-all duration-300 flex flex-col justify-between">
                    <div className="flex justify-between  mb-[71px]">
                        <p className="text--4xl font-semibold w-1/2  ">Find More</p>
                        <svg
                            className="rounded-full p-[10px] w-[50px] h-[50px] md:w-[72px] md:h-[72px] md:p-[20px]  transition-transform duration-300 bg-[#C5E5FF]  group-hover:border-solid group-hover:border-[#C5E5FF]  group-hover:border-[3px] group-hover:rotate-45  group-hover:bg-white "
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                    ...
                    <p className="text--lg  ">Browse Disease or find drugs on your nearest pharmacy!</p>
                </div>
            </div>
        </motion.div>
    );
