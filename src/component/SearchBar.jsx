...
export const SearchBar = ({ onSearch, placeholder, clearTrigger, onclick, value }) => {
    ...
    return (
        <form onSubmit={handleSearch} className="flex w-full bg-white rounded-full">
            <input
                type="text"
            ...
            />
            <button type="submit" onClick={onclick} className="bg-trinary p-5 2xl:p-6 rounded-full">
