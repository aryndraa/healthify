      ...
      <section className="mt-[100px] lg:mt-[160px] mb-2 lg:mb-4">
        <div className="lg:flex gap-4 mb-2 lg:mb-4">
          <img
            ...
            alt=""
            className="hidden lg:block w-[420px] 2xl:w-[549px]  object-cover rounded-xxl"
          />
          <iframe
            title="Google Maps"
          ...
          <div className="flex-1  ">
            <div
              className="bg-white rounded-xl lg:rounded-xxl p-4 lg:p-8 2xl:p-12 flex flex-col gap-4 lg:gap-0 lg:flex-row lg:justify-between mb-2 lg:mb-4">
              <div className="flex flex-col gap-2 lg:gap-4 2xl:gap-6 lg:max-w-[60%]">
                <h1 className="text-2xl lg:text-3xl 2xl:text-5xl font-semibold">Dyven Pharmacy</h1>
                <p className="text-sm lg:text-base 2xl:text-lg">Jl. Diponegoro No.125, Dauh Puri Klod, Kec. Denpasar
            ...
            <div className="grid grid-cols-2 lg:flex items-stretch gap-2 lg:gap-4">
              <img
                src="https://images.unsplash.com/photo-1604145942179-63cd583fcf64?q=80&w=3041&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
                className="w-full h-[140px] lg:h-[210px] 2xl:h-[311px] rounded-xl 2xl:rounded-xxl flex-1  object-cover"
              />
              <img
                src="https://images.unsplash.com/photo-1604145942179-63cd583fcf64?q=80&w=3041&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt=""
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-2 lg:gap-4">
          <div className="lg:w-[420px] 2xl:w-[549px]">
            <h2
              className="mb-2 lg:mb-3 2xl:mb-4 bg-white p-4 lg:py-5 lg:px-6 2xl:p-8 text-lg lg:text-xl 2xl:text-2xl font-semibold lg:font-semibold rounded-xl lg:rounded-xxl">Clinic
              Facility</h2>
