            ...
            return (
                <>
                    <DiseaseInfo title="Definisi">
                        <p className=" leading-[1.6]">{detail.definisi}</p>
                    </DiseaseInfo>
                    ...
                    <DiseaseInfo title="Complication">
                        <p className=" leading-[1.6]">{detail.komplikasi}</p>
                    </DiseaseInfo>
                </>
            );
            ...
            return (
                <>
                    ...
                    <DiseaseInfo title="Durasi Perawatan">
                        <p className=" leading-[1.6]">Pengobatan asma bersifat jangka panjang dan memerlukan pemantauan rutin untuk menyesuaikan pengobatan sesuai kebutuhan.</p>
                    </DiseaseInfo>
                </>
            );
        }
                ...
                <div className="flex flex-col lg:flex-row gap-4">
                    <div className="flex-1">
                        ...
                        <div className="rounded-xl lg:rounded-xxl bg-white mt-4 p-4 lg:p-8 2xl:p-12">
                            ...
                            <div className="flex flex-col gap-4 2xl:gap-6">{tabInfo()}</div>
                        </div>
                    </div>
