export const dieases = [
  {
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Inhaler bronkodilator untuk meredakan gejala",
          "Obat anti-inflamasi (kortikosteroid) untuk mengurangi peradangan"
        ]
      },
      {
        name: "mandiri",
        list: [
           ...
           "Menggunakan obat pencegahan sesuai anjuran dokter."
        ]
      },
      {
        name: "alternatif",
    ...
    komplikasi: "Jika tidak dikelola dengan baik, asma bronkial dapat menyebabkan serangan parah yang mengancam jiwa. Selain itu, penderita berisiko mengalami perubahan permanen pada saluran napas, yang dapat mengurangi fungsi paru-paru dan kualitas hidup. "
  },
  {
    id: 2,
    ...
    definisi: "Bronchitis acuta adalah peradangan pada saluran bronkus, biasanya disebabkan oleh infeksi virus. Kondisi ini menyebabkan batuk dan produksi lendir, dan umumnya bersifat sementara. Dengan perawatan yang tepat, bronchitis acuta biasanya sembuh dalam beberapa minggu.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      ...
      },
      {
        name: "mandiri",
        list: [
            "Istirahat yang cukup, minum banyak cairan (air putih, jus), dan makan makanan bergizi. Hindari asap rokok dan iritan lainnya.\n"
        ]
      },
      {
        name: "alternatif",
        list: [
         " Inhalasi uap hangat dengan sedikit minyak kayu putih atau eucalyptus dapat membantu meredakan saluran napas yang tersumbat. Namun, ini bukan pengganti pengobatan medis.\n"
        ]
      },
    ],
    ...
    komplikasi: "Bronchitis acuta yang tidak diobati dengan baik dapat menyebabkan komplikasi seperti pneumonia (infeksi paru-paru) atau perburukan kondisi paru-paru yang sudah ada sebelumnya, seperti asma atau PPOK. Pada kasus yang jarang, bronchitis acuta dapat menyebabkan gagal napas"
  },
  {
    id: 3,
    name: "cholera",
    ...
    definisi:  "Cholera adalah infeksi usus akut yang disebabkan oleh bakteri Vibrio cholerae, yang ditularkan melalui air atau makanan yang terkontaminasi. Penyakit ini dapat menyebabkan diare parah dan dehidrasi, yang jika tidak diobati dapat berakibat fatal.\n",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
            "Rehidrasi oral atau intravena untuk menggantikan cairan dan elektrolit yang hilang.\n"
        ]
      },
      {
        name: "mandiri",
        list: [
            "Mengonsumsi larutan rehidrasi oral (ORS) untuk mengatasi dehidrasi.\n"
        ]
      },
      {
        name: "alternatif",
        list: [
          "Antibiotik untuk mengurangi durasi diare (dengan konsultasi dokter).\n"
        ]
      },
    ],
    ...
    komplikasi: "Cholera dapat menyebabkan komplikasi serius, termasuk dehidrasi berat, syok hipovolemik, dan kematian jika tidak diobati. Tingkat kematian dapat tinggi, terutama di daerah dengan akses terbatas ke perawatan medis.\n\n"
  },
  {
    id: 4,
    name: "diphtheria",
    ...
    definisi: "Diphtheria adalah infeksi bakteri yang disebabkan oleh Corynebacterium diphtheriae, yang dapat mempengaruhi saluran pernapasan dan menyebabkan pembentukan selaput di tenggorokan. Penyakit ini dapat berakibat fatal jika tidak diobati, terutama pada anak-anak.\n",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    penyebab: [
      "Infeksi oleh Corynebacterium diphtheriae.\n",
      "Penularan melalui percikan udara dari batuk atau bersin.",
      "Kontak langsung dengan luka atau benda yang terkontaminasi.\n"
    ],
    pengobatan: [
      {
        name: "medis",
        list: [
              "Pemberian antitoksin dan antibiotik untuk mengatasi infeksi."
        ]
      },
      {
        name: "mandiri",
      ...
      },
      {
        name: "alternatif",
        list: [
         "Tidak ada pengobatan alternatif yang terbukti efektif; vaksinasi adalah pencegahan utama.\n"
        ]
      },
    ],
    ...
    komplikasi: "Diphtheria dapat menyebabkan komplikasi serius, termasuk kerusakan jantung, kerusakan saraf, dan kesulitan bernapas yang dapat mengancam jiwa. Jika tidak diobati, infeksi ini dapat berakibat fatal.\n"
  },
  {
    id: 5,
    name: "epilepsia",
    ...
    definisi: "Epilepsia adalah gangguan neurologis kronis yang ditandai oleh serangan kejang berulang akibat aktivitas listrik abnormal di otak. Kondisi ini dapat mempengaruhi berbagai fungsi tubuh dan mental, tergantung pada jenis kejang yang dialami.\n",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
              "Pemberian obat antiepilepsi untuk mengontrol kejang.\n"
        ]
      },
      {
        name: "mandiri",
        list: [
           "Menghindari pemicu kejang, seperti stres atau kurang tidur."
        ]
      },
      {
        name: "alternatif",
        list: [
         "Terapi diet ketogenik atau stimulasi saraf vagus (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    komplikasi: "Epilepsia dapat menyebabkan komplikasi serius, termasuk cedera akibat kejang, gangguan mental, dan dampak sosial yang signifikan. Penderita juga berisiko mengalami status epileptikus, yaitu serangan kejang yang berlangsung lebih dari 5 menit atau serangan berulang tanpa pemulihan di antara serangan.\n"
  },
  {
    id: 6,
    name: "fibromialgia",
    ...
    definisi: "Fibromialgia adalah gangguan kronis yang ditandai oleh nyeri muskuloskeletal yang meluas, disertai kelelahan, gangguan tidur, dan masalah memori. Kondisi ini sering kali mempengaruhi kualitas hidup dan aktivitas sehari-hari.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    penyebab: [
      ...
      "Infeksi atau penyakit sebelumnya.",
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
            "Obat pereda nyeri dan antidepresan untuk mengelola gejala."
        ]
      },
      {
        name: "mandiri",
        list: [
           "Latihan fisik ringan, teknik relaksasi, dan terapi panas."
        ]
      },
      {
        name: "alternatif",
        list: [
         "Akupunktur, yoga, atau terapi pijat (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    komplikasi: "Fibromialgia dapat menyebabkan penurunan kualitas hidup, gangguan emosional seperti depresi dan kecemasan, serta kesulitan dalam menjalani aktivitas sehari-hari. Kondisi ini juga dapat mempengaruhi hubungan sosial dan pekerjaan."
  },
  {
    id: 7,
    ...
    definisi: "Arthritis urica, atau gout, adalah jenis arthritis yang disebabkan oleh penumpukan kristal asam urat di sendi, yang mengakibatkan peradangan dan nyeri hebat. Kondisi ini sering kali terjadi secara tiba-tiba dan dapat mempengaruhi kualitas hidup.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
            "Obat anti-inflamasi non-steroid (NSAID) dan kolkisin untuk mengurangi nyeri dan peradangan."
        ]
      },
      {
        name: "mandiri",
        list: [
           "Istirahat dan mengompres sendi yang terkena dengan es."
        ]
      },
      {
        name: "alternatif",
        list: [
         " Suplemen herbal dan perubahan pola makan (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    pencegahan: [
        ...
        "Menjaga hidrasi yang baik dengan banyak minum air.",
        "Mengelola berat badan yang sehat."
    ],
    komplikasi: "Jika tidak diobati, gout dapat menyebabkan kerusakan permanen pada sendi dan ginjal, serta meningkatkan risiko penyakit jantung. Serangan berulang dapat mengakibatkan penurunan kualitas hidup dan keterbatasan aktivitas."
  },
  {
    id: 8,
    ...
    definisi: "Hypertensio arterialis, atau hipertensi, adalah kondisi medis di mana tekanan darah dalam arteri meningkat secara kronis. Jika tidak dikelola, hipertensi dapat menyebabkan komplikasi serius, termasuk penyakit jantung dan stroke.",
    gejala: [
      {
        name: "umum",
        list: [
      ...
      },
      {
        ...
        list: [
         "Penglihatan Kabur: Kesulitan melihat dengan jelas.",
          "Nyeri Dada: Rasa nyeri atau ketidaknyamanan di dada.",
          "Kesulitan Bernapas: Napas yang terasa berat atau sulit."
        ]
      }
    ],
    tahpan: [
    ...
    penyebab: [
      ...
      "Stres kronis.",
      "Penyakit ginjal atau gangguan hormonal."
    ],
    pengobatan: [
      {
        name: "medis",
      ...
      },
      {
        name: "alternatif",
        list: [
         " Terapi relaksasi dan pengelolaan stres (dengan konsultasi dokter)."
        ]
      },
    ],
 ...
 "     Melakukan aktivitas fisik secara teratur."
    ...
    komplikasi: "Hipertensi dapat menyebabkan berbagai komplikasi serius, termasuk penyakit jantung, stroke, dan kerusakan ginjal. Jika tidak dikelola dengan baik, kondisi ini dapat mengancam jiwa."
  },
  {
    id: 9,
    name: "Influenza",
    ...
    definisi: "Influenza, atau flu, adalah infeksi virus yang menyerang saluran pernapasan, termasuk hidung, tenggorokan, dan paru-paru. Penyakit ini sangat menular dan dapat menyebabkan gejala yang bervariasi dari ringan hingga berat.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    penyebab: [
      "Infeksi oleh virus influenza tipe A, B, atau C.",
      "Penularan melalui percikan udara dari batuk atau bersin.",
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          " Antiviral untuk mengurangi durasi dan keparahan gejala."
        ]
      },
      {
        name: "mandiri",
        list: [
          "  Istirahat yang cukup, banyak minum cairan, dan menggunakan obat pereda nyeri."  
        ]
      },
      {
        name: "alternatif",
        list: [
         "Suplemen vitamin C dan herbal untuk mendukung sistem imun (dengan konsultasi dokter)."
        ]
      },
    ],
    durasi: "Pengobatan biasanya berlangsung selama 5-7 hari, tetapi gejala dapat bertahan lebih lama." ,
    pencegahan: [
      "Vaksinasi tahunan untuk influenza.",
      "Mencuci tangan secara teratur dan menjaga kebersihan.",
     " Menghindari kontak dengan orang yang terinfeksi."
      
      
    ],
    komplikasi: "Influenza dapat menyebabkan komplikasi serius, termasuk pneumonia, bronkitis, dan infeksi telinga. Pada individu dengan sistem imun yang lemah, risiko komplikasi meningkat secara signifikan."
  },
  {
    id: 10,
    ...
    definisi: "Japanese encephalitis adalah infeksi virus yang disebabkan oleh virus Japanese encephalitis (JEV), yang ditularkan melalui gigitan nyamuk. Penyakit ini dapat menyebabkan peradangan otak dan berpotensi mengancam jiwa, terutama di daerah pedesaan Asia dan Pasifik.",
    gejala: [
      {
        name: "umum",
        list: [
          "Demam Tinggi: Suhu tubuh yang meningkat secara mendadak.",
    ...
    penyebab: [
      "Infeksi oleh virus Japanese encephalitis (JEV).",
     " Penularan melalui gigitan nyamuk, terutama nyamuk Culex.",
      "Tinggal atau bepergian ke daerah endemik tanpa perlindungan."
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Tidak ada pengobatan spesifik untuk infeksi JEV; perawatan bersifat suportif untuk mengelola gejala."
        ]
      },
      {
        name: "mandiri",
      ...
      },
      {
        name: "alternatif",
        list: [
         "Terapi rehabilitasi untuk pemulihan setelah gejala mereda (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    komplikasi: "Japanese encephalitis dapat menyebabkan komplikasi serius, termasuk kerusakan otak permanen, gangguan neurologis, dan kematian. Tingkat kematian dan kecacatan bervariasi tergantung pada usia dan kesehatan individu."
  },
  {
    id: 11,
    name: "Keratitis",
    ...
    definisi: "Keratitis adalah peradangan pada kornea, lapisan transparan di depan mata, yang dapat disebabkan oleh infeksi, cedera, atau kondisi lainnya. Jika tidak diobati, keratitis dapat menyebabkan kerusakan permanen pada penglihatan.",
    gejala: [
      {
        name: "umum",
        list: [
          "Nyeri Mata: Rasa sakit atau ketidaknyamanan di mata.",
         " Penglihatan Kabur: Kesulitan melihat dengan jelas.",
          "Kemerahan: Mata yang tampak merah atau meradang.",
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Antibiotik atau antivirus untuk mengatasi infeksi."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Menghindari penggunaan lensa kontak hingga sembuh dan menjaga kebersihan mata."  
        ]
      },
      {
        name: "alternatif",
        list: [
         "Obat tetes mata untuk mengurangi peradangan (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    komplikasi: "Keratitis dapat menyebabkan komplikasi serius, termasuk kerusakan permanen pada kornea, infeksi yang menyebar, dan kehilangan penglihatan. Penanganan yang cepat dan tepat sangat penting untuk mencegah kerusakan lebih lanjut."
  },
  {
    id: 12,
    name: "Leptospirosis",
    ...
    gejala: [
      ...
      },
      {
        name: "spesifik",
        list: [
         " Nyeri Otot: Nyeri di otot dan sendi.",
          "Muntah: Muntah yang dapat menyertai gejala lainnya.",
          "Rash: Ruam kulit yang mungkin muncul pada beberapa pasien."
    ...
    penyebab: [
      ...
      "Kontak dengan air atau tanah yang terkontaminasi urin" ,"hewan, seperti tikus, anjing, dan hewan ternak.",
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Antibiotik seperti doksisiklin atau penicillin untuk mengatasi infeksi."
        ]
      },
      {
        name: "mandiri",
      ...
      },
      {
        name: "alternatif",
        list: [
         "Tidak ada pengobatan alternatif yang terbukti efektif; pengobatan medis adalah yang utama."
        ]
      },
    ],
  ...
  },
  {
    ...
    definisi: "Malaria adalah infeksi parasit yang disebabkan oleh Plasmodium, yang ditularkan melalui gigitan nyamuk Anopheles. Penyakit ini dapat menyebabkan gejala yang parah dan berpotensi mengancam jiwa jika tidak diobati.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Obat antimalaria seperti artemisinin, klorokuin, atau lumefantrin untuk mengatasi infeksi"
        ]
      },
      {
        name: "mandiri",
    ...
    komplikasi: "Malaria dapat menyebabkan komplikasi serius, termasuk anemia berat, gagal ginjal, gangguan pernapasan, dan kematian. Plasmodium falciparum adalah spesies yang paling berbahaya dan dapat menyebabkan kematian dalam waktu singkat jika tidak diobati."
  },
  {
    id: 14,
    name: "Nephritis",
    ...
    definisi: "Nephritis adalah peradangan pada ginjal yang dapat mempengaruhi fungsi ginjal. Penyakit ini dapat disebabkan oleh infeksi, penyakit autoimun, atau reaksi terhadap obat-obatan. Nephritis dapat menyebabkan kerusakan ginjal yang serius jika tidak diobati.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Antibiotik untuk infeksi, obat antiinflamasi, dan obat untuk mengontrol tekanan darah."
        ]
      },
      {
        name: "mandiri",
      ...
      },
      {
        name: "alternatif",
        list: [
         "Terapi diet untuk mengurangi beban pada ginjal (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    komplikasi: "Nephritis dapat menyebabkan komplikasi serius, termasuk gagal ginjal, hipertensi, dan kerusakan permanen pada ginjal. Penanganan yang cepat dan tepat sangat penting untuk mencegah kerusakan lebih lanjut."
  },
  {
    id: 15,
    name: "Osteoporosis",
    ...
    definisi: "Osteoporosis adalah kondisi medis yang ditandai oleh penurunan kepadatan tulang, yang membuat tulang menjadi lemah dan lebih rentan terhadap patah. Penyakit ini sering kali tidak menunjukkan gejala hingga terjadi patah tulang.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Obat bisfosfonat untuk meningkatkan kepadatan tulang dan mengurangi risiko patah."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Mengatur pola makan yang kaya kalsium dan vitamin D, serta melakukan latihan beban."  
        ]
      },
      {
        name: "alternatif",
        list: [
         "Suplemen kalsium dan vitamin D (dengan konsultasi dokter)."
        ]
      },
    ],
    durasi: "Pengobatan biasanya bersifat jangka panjang dan memerlukan pemantauan rutin." ,
    ...
    komplikasi: "Osteoporosis dapat menyebabkan patah tulang yang serius, terutama pada pinggul, pergelangan tangan, dan tulang belakang. Patah tulang ini dapat mengakibatkan komplikasi lebih lanjut, termasuk kecacatan dan penurunan kualitas hidup."
  },
  {
    id: 16,
    name: "Pneumonia",
    ...
    definisi: "Pneumonia adalah infeksi yang menginflamasi kantung udara di satu atau kedua paru-paru, yang dapat diisi dengan cairan atau nanah. Penyakit ini dapat disebabkan oleh berbagai mikroorganisme, termasuk bakteri, virus, dan jamur.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          " Antibiotik untuk pneumonia bakteri, antiviral untuk pneumonia virus, dan obat antijamur jika diperlukan."
        ]
      },
      {
        name: "mandiri",
        list: [
          "stirahat yang cukup dan menjaga hidrasi."  
        ]
      },
      {
        name: "alternatif",
        list: [
         "Terapi oksigen untuk membantu pernapasan (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    komplikasi: "Pneumonia dapat menyebabkan komplikasi serius, termasuk gagal napas, abses paru, dan sepsis. Pada individu dengan kondisi kesehatan yang sudah ada sebelumnya, risiko komplikasi meningkat secara signifikan."
  },
  {
    id: 17,
    name: "Q-fever",
    ...
    definisi: "Q-fever adalah infeksi bakteri yang disebabkan oleh Coxiella burnetii, yang biasanya ditularkan dari hewan, terutama domba, kambing, dan sapi, kepada manusia. Penyakit ini dapat menyebabkan gejala flu ringan hingga infeksi paru-paru yang lebih serius.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Antibiotik seperti doksisiklin untuk mengatasi infeksi."
        ]
      },
      {
        name: "mandiri",
    ...
    komplikasi: "Q-fever dapat menyebabkan komplikasi serius, termasuk pneumonia, hepatitis, dan endokarditis (infeksi pada lapisan jantung). Jika tidak diobati, infeksi ini dapat berakibat fatal."
  },
  {
    id: 17,
    name: "Q-fever",
  ...
  },
  {
    ...
    definisi: "Rubella, juga dikenal sebagai campak Jerman, adalah infeksi virus yang disebabkan oleh virus rubella. Penyakit ini biasanya ringan pada anak-anak, tetapi dapat menyebabkan komplikasi serius jika terjadi pada wanita hamil, termasuk cacat lahir pada janin.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    penyebab: [
      "Infeksi oleh virus rubella, yang menyebar melalui percikan udara dari batuk atau bersin.",
      "Penularan melalui kontak langsung dengan cairan tubuh dari individu yang terinfeksi."
    ],
    pengobatan: [
      {
        name: "medis",
        list: [
          "Tidak ada pengobatan spesifik untuk rubella; perawatan bersifat suportif untuk mengelola gejala."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Istirahat yang cukup, banyak minum cairan, dan menggunakan obat pereda nyeri untuk demam."  
        ]
      },
      {
        name: "alternatif",
    ...
    pencegahan: [
      "Vaksinasi dengan vaksin MMR (Measles, Mumps, Rubella) untuk mencegah infeksi.",
     " Menghindari kontak dengan individu yang terinfeksi, terutama bagi wanita hamil."
    ],
    komplikasi: "Rubella dapat menyebabkan komplikasi serius, terutama pada wanita hamil, termasuk sindrom rubella kongenital, yang dapat menyebabkan cacat lahir, kelahiran prematur, dan keguguran. Pada orang dewasa, dapat menyebabkan nyeri sendi dan komplikasi lainnya, meskipun jarang."
  },
  {
    id: 18,
    name: "Rubella",
  ...
  },
  {
    ...
    definisi: "Syphilis adalah infeksi menular seksual (IMS) yang disebabkan oleh bakteri Treponema pallidum. Penyakit ini dapat berkembang melalui beberapa tahap dan dapat menyebabkan komplikasi serius jika tidak diobati.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    penyebab: [
      "Infeksi oleh bakteri Treponema pallidum.",
      "Penularan melalui kontak langsung dengan luka atau lesi pada orang yang terinfeksi, biasanya melalui hubungan seksual."
    ],
    pengobatan: [
      {
        name: "medis",
        list: [
          "Antibiotik, biasanya penisilin, untuk mengatasi infeksi."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Istirahat yang cukup dan menjaga kesehatan secara umum."  
        ]
      },
      {
        name: "alternatif",
    ...
    komplikasi: "Syphilis dapat menyebabkan komplikasi serius jika tidak diobati, termasuk kerusakan permanen pada jantung, otak, dan sistem saraf, serta masalah kesehatan lainnya. Pada wanita hamil, infeksi dapat menyebabkan cacat lahir atau kematian janin."
  },
  {
    id: 20,
    name: "Tuberculosis",
    ...
    definisi: "Tuberculosis (TB) adalah infeksi bakteri yang disebabkan oleh Mycobacterium tuberculosis, yang biasanya menyerang paru-paru tetapi juga dapat mempengaruhi bagian tubuh lainnya. Penyakit ini menular melalui udara ketika seseorang yang terinfeksi batuk atau bersin.z",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    penyebab: [
      ...
      "Penularan melalui udara dari individu yang terinfeksi."
    ],
    pengobatan: [
      {
        name: "medis",
        list: [
          "Regimen antibiotik yang terdiri dari beberapa obat, seperti isoniazid, rifampisin, etambutol, dan pirazinamid, biasanya selama 6-9 bulan."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Istirahat yang cukup dan menjaga nutrisi yang baik."  
        ]
      },
      {
        name: "alternatif",
    ...
    komplikasi: "Tuberculosis dapat menyebabkan komplikasi serius, termasuk kerusakan paru-paru permanen, penyebaran infeksi ke organ lain (seperti ginjal, tulang, dan otak), dan kematian jika tidak diobati. TB yang resisten terhadap obat juga menjadi tantangan besar dalam pengobatan."
  },
  {
    id: 21,
    name: "Varicella",
    ...
    definisi: "Varicella, atau cacar air, adalah infeksi virus yang disebabkan oleh virus varicella-zoster (VZV). Penyakit ini sangat menular dan ditandai dengan munculnya ruam kulit yang gatal dan bercak-bercak berisi cairan.",
    gejala: [
      {
        name: "umum",
        list: [
          "Demam Ringan: Suhu tubuh yang sedikit meningkat.",
          "Kelelahan: Rasa lelah yang signifikan dan tidak biasa.",
          "Sakit Kepala: Rasa sakit yang dapat menyertai gejala lainnya."
        ]
      },
      {
        name: "spesifik",
    ...
    penyebab: [
      "Infeksi oleh virus varicella-zoster (VZV).",
      "Penularan melalui percikan udara dari batuk atau bersin, serta kontak langsung dengan lepuh."
    ],
    pengobatan: [
      {
        name: "medis",
        list: [
          "Antiviral seperti asiklovir untuk mengurangi keparahan dan durasi gejala, terutama pada individu dengan risiko tinggi."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Menggunakan obat antihistamin untuk mengurangi gatal dan menjaga kebersihan kulit."  
        ]
      },
      {
        name: "alternatif",
    ...
    komplikasi: "Varicella dapat menyebabkan komplikasi serius, terutama pada orang dewasa dan individu dengan sistem imun yang lemah, termasuk pneumonia, infeksi kulit, dan sindrom Reye. Pada wanita hamil, infeksi dapat menyebabkan cacat lahir pada janin."
  },
  {
    id: 22,
    name: "Febris Dengue",
    ...
    definisi: "Febris dengue, atau demam dengue, adalah infeksi virus yang disebabkan oleh virus dengue, yang ditularkan melalui gigitan nyamuk Aedes, terutama Aedes aegypti. Penyakit ini dapat menyebabkan gejala ringan hingga berat dan berpotensi mengancam jiwa.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    penyebab: [
      "Infeksi oleh virus dengue, yang terdiri dari empat serotipe (DEN-1, DEN-2, DEN-3, DEN-4).",
      "Penularan melalui gigitan nyamuk Aedes yang terinfeksi."
    ],
    pengobatan: [
      {
        name: "medis",
        list: [
          "Tidak ada pengobatan spesifik untuk demam dengue; perawatan bersifat suportif untuk mengelola gejala."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Istirahat yang cukup, banyak minum cairan, dan menggunakan obat pereda nyeri seperti parasetamol."  
        ]
      },
      {
        name: "alternatif",
    ...
    komplikasi: "Febris dengue dapat menyebabkan komplikasi serius, termasuk demam dengue berat, dengue hemorrhagic fever, dan sindrom syok dengue, yang dapat mengancam jiwa. Penanganan yang cepat dan tepat sangat penting untuk mencegah kerusakan lebih lanjut."
  },
  {
    id: 23,
    name: "Xeroderma",
    ...
    definisi: "Xeroderma adalah kondisi kulit yang ditandai oleh kekeringan, pengelupasan, dan kerutan pada kulit. Penyakit ini dapat disebabkan oleh berbagai faktor, termasuk paparan sinar matahari, dehidrasi, dan kondisi medis tertentu.    ",
    gejala: [
      {
        name: "umum",
        list: [
          "Kulit Kering: Kulit yang terasa kering dan kasar.",
          "Pengelupasan: Kulit yang mengelupas atau bersisik.",
          "Gatal: Rasa gatal yang dapat menyertai kekeringan kulit."
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Krim atau salep pelembap untuk mengatasi kekeringan."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Menggunakan pelembap secara teratur dan menjaga hidrasi"  
        ]
      },
      {
        name: "alternatif",
        list: [
         "Minyak alami seperti minyak kelapa atau minyak zaitun untuk melembapkan kulit (dengan konsultasi dokter)."
        ]
      },
    ],
    ...
    komplikasi: "Xeroderma dapat menyebabkan komplikasi seperti infeksi kulit akibat retakan yang terbuka dan rasa tidak nyaman yang signifikan. Jika tidak diobati, kondisi ini dapat mempengaruhi kualitas hidup."
  },
  {
    id: 24,
    name: "Yellow Feve",
    ...
    definisi: "Yellow fever adalah infeksi virus yang disebabkan oleh virus yellow fever, yang ditularkan melalui gigitan nyamuk Aedes atau Haemagogus. Penyakit ini dapat menyebabkan gejala yang bervariasi dari ringan hingga berat dan dapat berakibat fatal.",
    gejala: [
      {
        name: "umum",
        list: [
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          "Tidak ada pengobatan spesifik untuk yellow fever; perawatan bersifat suportif untuk mengelola gejala."
        ]
      },
      {
        name: "mandiri",
      ...
      },
      {
        name: "alternatif",
        list: [
         "idak ada pengobatan alternatif yang terbukti efektif; pengobatan medis"
        ]
      },
    ],
    ...
    komplikasi: "Yellow fever dapat menyebabkan komplikasi serius, termasuk gagal hati, perdarahan internal, dan kematian. Tingkat kematian dapat tinggi, terutama pada individu yang tidak divaksinasi."
  },
  {
    id: 25,
    name: " Zika Virus",
    ...
    definisi: "Zika virus adalah infeksi yang disebabkan oleh virus Zika, yang ditularkan melalui gigitan nyamuk Aedes, terutama Aedes aegypti. Penyakit ini sering kali ringan, tetapi dapat menyebabkan komplikasi serius, terutama pada wanita hamil.",
    gejala: [
      {
        name: "umum",
        list: [
        "  Demam Ringan: Suhu tubuh yang sedikit meningkat.",
          "Rash: Ruam kulit yang dapat muncul di seluruh tubuh.",
          "Kelelahan: Rasa lelah yang signifikan dan tidak biasa."
    ...
    pengobatan: [
      {
        name: "medis",
        list: [
          " Tidak ada pengobatan spesifik untuk infeksi Zika; perawatan bersifat suportif untuk mengelola gejala."
        ]
      },
      {
        name: "mandiri",
        list: [
          "Istirahat yang cukup, banyak minum cairan, dan menggunakan obat pereda nyeri untuk demam dan nyeri."  
        ]
      },
      {
        name: "alternatif",
    ...
    komplikasi: "Zika virus dapat menyebabkan komplikasi serius, termasuk sindrom Guillain-Barré, dan dapat menyebabkan cacat lahir seperti mikrocefali pada bayi yang terinfeksi dalam kandungan. Oleh karena itu, pencegahan sangat penting, terutama bagi wanita hamil."
  },
